...
function Update () {
	...
	if (distanceFromPlayer <=15 && distanceFromPlayer >=8){//REMEMBER TO EDIT THESE VALUES IN ENEMYSHOOTPROJECTILE.JS AS WELL IF YOU CHANGE THEM, TO ENSURE THEY MATCH UP
